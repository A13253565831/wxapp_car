...
module.exports = {
  ...
  //汽车车系
  getserieslist: WYY_HOST_URL + "/Wap.php/" + type + "/getserieslist",
  //获取车型
  getmodellist: WYY_HOST_URL + "/Wap.php/" + type + "/getmodellist",
  //车型详情
  getmodeldetail: WYY_HOST_URL + "/Wap.php/" + type + "/getmodeldetail",
  // 获取视频
